...
def create_app(demo: bool = False) -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        engine.set_overlay_settings(
            app.state.settings.auto_fuel_enabled,
            app.state.settings.auto_fuel_source,
            app.state.settings.auto_fuel_buffer_laps,
        )
    ...
    async def api_post_settings(payload: OverlaySettings) -> OverlaySettings:
        ...
        app.state.engine.set_overlay_settings(
            payload.auto_fuel_enabled, payload.auto_fuel_source, payload.auto_fuel_buffer_laps
        )
        return payload
